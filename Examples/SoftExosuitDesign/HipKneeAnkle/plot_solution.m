...
for x=1:11
    ...
    if x>1
        ...
        text(1,1.25,'Knee Extension / Hip Flexion','FontAngle','italic')
        text(1,-1.25,'Knee Flexion / Ankle Plantarflexion','FontAngle','italic')
        ax = gca;
        ax.LineWidth = 1.5;
        ...
        hold on
        plot(time,kneeID,'k-','LineWidth',1.75)
        title('Knee Moment','FontAngle','italic')
        ax = gca;
        ax.LineWidth = 1.5;
...
h5 = figure('units','normalized','position',[0 0 0.5 1]);
