function phaseout = continous_lMtildeExoHipExtHipAbd_Exc_Act(input)
...
[Hilldiff, F] = ForceEquilibrium_lMtildeStateExoHipExtHipAbd_Exc_Act(a,lMtilde,vMtilde,splinestruct.LMT,params,input.auxdata.Fvparam,input.auxdata.Fpparam,input.auxdata.Faparam);
