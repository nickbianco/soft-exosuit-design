function phaseout = musdynContinous_lMtildeState_Exc(input)
...
[Hilldiff, F] = ForceEquilibrium_lMtildeState_Exc(a,lMtilde,vMtilde,splinestruct.LMT,params,input.auxdata.Fvparam,input.auxdata.Fpparam,input.auxdata.Faparam);
